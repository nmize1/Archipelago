...
location_table = [
    ...
    },
    {
        ...
        "requires": "|Homer Kick| OR (|Homer Double Jump| AND |Homer Ground Pound|) OR {YamlDisabled(moverandomizer)}",
        "id": 122366
    },
    {
    ...
    },
    {
        ...
        "requires": "|Homer Double Jump| AND (|Homer Kick| OR |Homer Ground Pound|) OR {YamlDisabled(moverandomizer)}",
        "id": 122383
    },
    {
    ...
    },
    {
        ...
        "requires": "|Bart Kick| OR (|Bart Double Jump| AND |Bart Ground Pound|) OR {YamlDisabled(moverandomizer)}",
        "id": 122413
    },
    {
    ...
    },
    {
        ...
        "requires": "((|Bart Kick| OR |Bart Ground Pound|) AND |Bart Double Jump|)",
        "id": 122417
    },
    {
    ...
    },
    {
        ...
        "requires": "|Lisa Kick| OR (|Lisa Double Jump| AND |Lisa Ground Pound|) OR {YamlDisabled(moverandomizer)}",
        "id": 122463
    },
    {
    ...
    },
    {
        ...
        "requires": "((|Lisa Kick| OR |Lisa Ground Pound|) AND |Lisa Double Jump|)",
        "id": 122475
    },
    {
    ...
    },
    {
        ...
        "requires": "|Marge Kick| OR (|Marge Double Jump| AND |Marge Ground Pound|) OR {YamlDisabled(moverandomizer)}",
        "id": 122501
    },
    {
    ...
    },
    {
        ...
        "requires": "|Apu Kick| OR (|Apu Double Jump| AND |Apu Ground Pound|) OR {YamlDisabled(moverandomizer)}",
        "id": 122549
    },
    {
    ...
    },
    {
        ...
        "requires": "((|Apu Kick| OR |Apu Ground Pound|) AND |Apu Double Jump|) OR {YamlDisabled(moverandomizer)}",
        "id": 122553
    },
    {
    ...
    },
    {
        ...
        "requires": "((|Bart Kick| OR |Bart Ground Pound|) AND |Bart Double Jump|) OR {YamlDisabled(moverandomizer)}",
        "id": 122601
    },
    {
    ...
    },
    {
        ...
        "requires": "((|Homer Kick| OR |Homer Ground Pound|) AND |Homer Double Jump|) OR {YamlDisabled(moverandomizer)}",
        "id": 122640
    },
    {
