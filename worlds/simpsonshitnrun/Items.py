...
ITEM_DEFS = {
    ...
    "Family Sedan": ItemDef(121810, ItemClassification.useful, True, [1], "Small", "famil_v"),
    "Plow King": ItemDef(121811, ItemClassification.progression, True, [1], "Large", "plowk_v"),
    "Duff Truck": ItemDef(121812, ItemClassification.useful, True, [1], "Large", "cDuff"),
    "Surveillance Van": ItemDef(121813, ItemClassification.useful, True, [1], "Medium", "cVan"),
    "Pickup Truck": ItemDef(121814, ItemClassification.useful, True, [1], "Medium", "cletu_v"),
    "Electaurus": ItemDef(121815, ItemClassification.useful, True, [1], "Small", "elect_v"),

    "Mr. Plow": ItemDef(121816, ItemClassification.progression, True, [2], "Medium", "mrplo_v"),
    "Limo": ItemDef(121817, ItemClassification.useful, True, [2], "Small", "cLimo"),
    "Fire Truck": ItemDef(121818, ItemClassification.useful, True, [2], "Large", "cFire_v"),
    "WWII Vehicle": ItemDef(121819, ItemClassification.useful, True, [2], "Medium", "gramp_v"),
    "Moe's Sedan": ItemDef(121820, ItemClassification.useful, True, [2], "Small", "moe_v"),

    "School Bus": ItemDef(121821, ItemClassification.progression, True, [3], "Large", "otto_v"),
    "Donut Truck": ItemDef(121822, ItemClassification.useful, True, [3], "Medium", "cDonut"),
    "Nerd Car": ItemDef(121823, ItemClassification.useful, True, [3], "Small", "cNerd"),
    "Skinner's Sedan": ItemDef(121824, ItemClassification.useful, True, [3], "Medium", "skinn_v"),
    "Book Burning Van": ItemDef(121825, ItemClassification.useful, True, [3], "Medium", "bookb_v"),

    "Tractor": ItemDef(121826, ItemClassification.useful, True, [4], "Medium", "willi_v"),
    "Curator": ItemDef(121827, ItemClassification.useful, True, [4], "Small", "cCurator"),
    "Krusty's Limo": ItemDef(121828, ItemClassification.useful, True, [4], "Small", "cKlimo"),
    "Kremlin": ItemDef(121829, ItemClassification.useful, True, [4], "Small", "comic_v"),
    "Clown Car": ItemDef(121830, ItemClassification.useful, True, [4], "Small", "krust_v"),

    "Car Built For Homer": ItemDef(121831, ItemClassification.progression, True, [5], "Small", "carhom_v"),
    "Cola Truck": ItemDef(121832, ItemClassification.useful, True, [5], "Large", "cCola"),
    "Police Car": ItemDef(121833, ItemClassification.useful, True, [5], "Small", "wiggu_v"),
    "Hover Car": ItemDef(121834, ItemClassification.useful, True, [5], "Small", "frink_v"),
    "El Carro Loco": ItemDef(121835, ItemClassification.useful, True, [5], "Small", "bbman_v"),

    "Globex Super Villain Car": ItemDef(121836, ItemClassification.progression, True, [6], "Small", "scorp_v"),
    "Armored Truck": ItemDef(121837, ItemClassification.useful, True, [6], "Large", "cArmor"),
    "Chase Sedan": ItemDef(121838, ItemClassification.useful, True, [6], "Small", "cSedan"),
    "Bandit": ItemDef(121839, ItemClassification.useful, True, [6], "Small", "snake_v"),
    "36 Stutz Bearcat": ItemDef(121840, ItemClassification.useful, True, [6], "Small", "burns_v"),

    "Zombie Car": ItemDef(121841, ItemClassification.progression, True, [7], "Small", "zombi_v"),
    "Hearse": ItemDef(121842, ItemClassification.useful, True, [7], "Small", "cHears"),
    "Mr. Burns' Limo": ItemDef(121843, ItemClassification.useful, True, [7], "Medium", "smith_v"),
    "Hover Bike": ItemDef(121844, ItemClassification.useful, True, [7], "Small", "hbike_v"),
    "Open Wheel Race Car": ItemDef(121845, ItemClassification.useful, True, [7], "Small", "fone_v"),

    "Honor Roller": ItemDef(121846, ItemClassification.useful, True, [2], "Small", "honor_v"),
    "Malibu Stacy Car": ItemDef(121847, ItemClassification.useful, True, [3], "Small", "lisa_v"),
    "Canyonero": ItemDef(121848, ItemClassification.useful, True, [4], "Medium", "marge_v"),
    "Longhorn": ItemDef(121849, ItemClassification.useful, True, [5], "Small", "apu_v"),
    "Ferrini - Red": ItemDef(121850, ItemClassification.useful, True, [6], "Small", "bart_v"),
    "70's Sports Car": ItemDef(121851, ItemClassification.useful, True, [7], "Small", "homer_v"),
    ...
    "Speed Rocket": ItemDef(121880, ItemClassification.useful, True, [1], "Small", "rocke_v"),
    "Monorail Car": ItemDef(121881, ItemClassification.useful, True, [2], "Medium", "mono_v"),
    "Knight Boat": ItemDef(121882, ItemClassification.useful, True, [3], "Small", "knigh_v"),
    "ATV": ItemDef(121883, ItemClassification.useful, True, [4], "Small", "atv_v"),
    "Obliteratatron Big Wheel Truck": ItemDef(121884, ItemClassification.useful, True, [5], "Extra Large", "oblit_v"),
    "Planet Hype 50's Car": ItemDef(121885, ItemClassification.useful, True, [6], "Small", "hype_v"),
    "R/C Buggy": ItemDef(121886, ItemClassification.useful, True, [7], "Extra Small", "dune_v"),
    ...
    "Mini School Bus": ItemDef(121900, ItemClassification.filler, True, [1], "Large", "schoolbu"),
    "Glass Truck": ItemDef(121901, ItemClassification.filler, True, [1], "Medium", "glastruc"),
    "Minivan": ItemDef(121902, ItemClassification.filler, True, [1], "Medium", "minivanA"),
    "Pizza Van": ItemDef(121903, ItemClassification.filler, True, [2], "Medium", "pizza"),
    "Taxi": ItemDef(121904, ItemClassification.filler, True, [2], "Small", "taxiA"),
    "Sedan B": ItemDef(121905, ItemClassification.filler, True, [2], "Small", "sedanB"),
    "Fish Van": ItemDef(121906, ItemClassification.filler, True, [3], "Medium", "fishtruc"),
    "Garbage Truck": ItemDef(121907, ItemClassification.filler, True, [4], "Large", "garbage"),
    "Nuclear Waste Truck": ItemDef(121908, ItemClassification.filler, True, [4], "Medium", "nuctruck"),
    "Pickup": ItemDef(121909, ItemClassification.filler, True, [1, 3, 6], "Medium", "pickupA"),
    "Sports Car A": ItemDef(121910, ItemClassification.filler, True, [3], "Small", "sportsA"),
    "Compact Car": ItemDef(121911, ItemClassification.filler, True, [3, 4, 6], "Small", "compactA"),
    "SUV": ItemDef(121912, ItemClassification.filler, True, [4, 5], "Small", "SUVA"),
    "Hallo Hearse": ItemDef(121913, ItemClassification.filler, True, [7], "Small", "hallo"),
    "Coffin Car": ItemDef(121914, ItemClassification.filler, True, [7], "Small", "coffin"),
    "Ghost Ship": ItemDef(121915, ItemClassification.filler, True, [7], "Small", "ship"),
    "Witch Broom": ItemDef(121916, ItemClassification.filler, True, [7], "Small", "witchcar"),
    "Sedan A": ItemDef(121917, ItemClassification.filler, True, [8], "Small", "sedanA"),
    "Station Wagon": ItemDef(121918, ItemClassification.filler, True, [8], "Small", "wagonA"),
    "Ice Cream Truck": ItemDef(121919, ItemClassification.filler, True, [8], "Large", "icecream"),
    "Bonestorm Truck": ItemDef(121920, ItemClassification.filler, True, [8], "Large", "cBone"),
    "Cell Phone Car": ItemDef(121921, ItemClassification.filler, True, [8], "Small", f"cCellA"),
    "Milk Truck": ItemDef(121922, ItemClassification.filler, True, [8], "Large", "cMilk"),
    "Nonuplets Minivan": ItemDef(121923, ItemClassification.filler, True, [8], "Medium", "cNonup"),
    "Ferrini - Black": ItemDef(121924, ItemClassification.filler, True, [8], "Small", "cBlbart"),
    ...
    "Cube Van": ItemDef(121931, ItemClassification.filler, True, [8], "Large", "cCube"),
    "WWII Vehicle W\\ Rocket": ItemDef(121932, ItemClassification.useful, True, [7], "Medium", "gramR_v"),
    "Audi TT": ItemDef(121933, ItemClassification.useful, True, [8], "Small", "tt"),
    "Vote Quimby Truck": ItemDef(121934, ItemClassification.useful, True, [5], "Large", "votetruc"),
    "Ambulance": ItemDef(121935, ItemClassification.useful, True, [5], "Large", "ambul"),
    "Sports Car B": ItemDef(121936, ItemClassification.useful, True, [2, 5], "Small", "sportsB"),
    "Itchy and Scratchy Movie Truck": ItemDef(121937, ItemClassification.progression, True, [6], "Large", "IStruck"),
    "Burns Armored Truck": ItemDef(121938, ItemClassification.progression, True, [6], "Large", "burnsarm"),
